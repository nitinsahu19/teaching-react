    ...
    <>
      ...
      <>
        ...
        <div className='bg-red-600 border rounded w-100 text-center'>
          ...
          <input type="text" onChange={(e) => setname(e.target.value)} className='p-2 border rounded m-2' placeholder='Enter Name' /> <br />
          <input  type="email" onChange={(e) => setemail(e.target.value)} className='p-2 border rounded m-2' placeholder='Enter Email' /><br />
      ...
      { page === 1 &&
        <>
          <div className='bg-red-600 mt-2 border rounded w-100 text-center'>
            ...
            <input  type="text" onChange={(e) => setcity(e.target.value)} className='p-2 border rounded m-2' placeholder='Enter City' /> <br />
            <input  type="text" onChange={(e) => setpincode(e.target.value)} className='p-2 border rounded m-2' placeholder='Enter Pincode' /><br />
