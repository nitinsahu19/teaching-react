      ...
      {page === 0 ? (
        <div className={`flex justify-center items-center min-h-screen ${theme === "light" ? "bg-white text-black" : "bg-black text-white"}`}>
          <div className="p-10 rounded border border-gray-700 w-full max-w-md">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
              <input value={name} onChange={(e) => setname(e.target.value)} className={` ${theme === "light" ? "bg-white text-black placeholder:text-black" : "bg-black text-white placeholder:text-white"} w-full border border-gray-600 p-2 rounded bg-transparent `} type="text" placeholder="Enter Name" />
              <input value={email} onChange={(e) => setemail(e.target.value)} className={` ${theme === "light" ? "bg-white text-black placeholder:text-black" : "bg-black text-white placeholder:text-white"} w-full border border-gray-600 p-2 rounded bg-transparent `} type="email" placeholder="Enter Email" />
        ...
        <div className={`flex justify-center items-center min-h-screen ${theme === "light" ? "bg-white text-black" : "bg-black text-white"} `}>
          <div className="p-10 rounded border border-gray-700 w-full max-w-md">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
              <input value={city} onChange={(e) => setcity(e.target.value)} className={`w-full border border-gray-600 p-2 rounded ${theme === "light" ? "bg-white text-black placeholder:text-black" : "bg-black text-white placeholder:text-white"}` } type="text" placeholder="Enter City" />
              <input value={pin} onChange={(e) => setpin(e.target.value)} className={`w-full border border-gray-600 p-2 rounded ${theme === "light" ? "bg-white text-black placeholder:text-black" : "bg-black text-white placeholder:text-white"}`} type="text" placeholder="Enter Pincode" />
