  ...
  return (
    <div>
      ...
      <div className="flex gap-2 mt-3 border w-fit rounded">
        <input className={` outline-0 rounded cursor-pointer `}  value={inputValue} type="text" name='comment' onChange={(e) => setinputValue(e.target.value)} onKeyDown={handleevent} placeholder="Enter a comment" />
